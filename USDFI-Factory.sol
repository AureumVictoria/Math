...
contract USDFIFactory is IUSDFIFactory {
    ...
    event BaseFeesUpdated(uint256 prevBaseFeeAmount, uint256 indexed _baseFeeAmount, uint256 prevBaseProtocolFeeShare, uint256 indexed _baseProtocolFeeShare, uint256 prevBaseOwnerFeeShare, uint256 indexed _baseOwnerFeeShare);
    ...
    function setBaseFees(uint256 _baseFeeAmount, uint256 _baseOwnerFeeShare, uint256 _baseProtocolFeeShare) external onlyOwner {
        ...
        emit BaseFeesUpdated(prevBaseFeeAmount, _baseFeeAmount, prevBaseProtocolFeeShare, _baseProtocolFeeShare, prevBaseOwnerFeeShare, _baseOwnerFeeShare);
    }
